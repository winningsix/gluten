...
class MppHashJoinInputSortRewriteSuite extends AnyFunSuite {
  ...
  test("a local sort is removed through deterministic native and Spark projects") {
    ...
    val rewritten = MppHashJoinInputSortRewrite.strip(outer)
  ...
  test("a nondeterministic project is a fail-closed boundary") {
    ...
    val rewritten = MppHashJoinInputSortRewrite.strip(project)
  ...
  test("a global sort is retained") {
    ...
    val rewritten = MppHashJoinInputSortRewrite.strip(sort)
