...
inline constexpr const char* kCheckOverflowInTableInsert = "check_overflow_in_table_insert";

std::string checkOverflowInTableInsertMessage(const std::string& quotedColumnName);

class CheckOverflowInTableInsertCallToSpecialForm final : public facebook::velox::exec::FunctionCallToSpecialForm {
 public:
