...
void VeloxBackend::init(
  ...
  if (backendConf_->get<bool>(kCudfEnabled, kCudfEnabledDefault)) {
    ...
    std::unordered_map<std::string, std::string> options = {
        ...
        {velox::cudf_velox::CudfConfig::kCudfTableWriteConcatEnabled,
         backendConf_->get(kCudfTableWriteConcatEnabled, kCudfTableWriteConcatEnabledDefault)},
        {velox::cudf_velox::CudfConfig::kCudfTableWriteConcatRows,
         backendConf_->get(kCudfTableWriteConcatRows, kCudfTableWriteConcatRowsDefault)},
        {velox::cudf_velox::CudfConfig::kCudfTableWriteConcatBytes,
         backendConf_->get(kCudfTableWriteConcatBytes, kCudfTableWriteConcatBytesDefault)},
